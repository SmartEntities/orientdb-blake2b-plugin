...
import static com.smartentities.plugins.blake2b.ArrayUtils.cloneByteArray;
import static com.smartentities.plugins.blake2b.ArrayUtils.fillByteArray;
...
import static com.smartentities.plugins.blake2b.Const.BLAKE2B_IV;
...
public class Blake2b {
    ...
    public void update(byte[] message, int offset, int len) {
        ...
        for (messagePos = offset + remainingLength; messagePos < blockWiseLastPos; messagePos += Const.BLOCK_LENGTH_BYTES) {
            // without buffer:
            t0 += Const.BLOCK_LENGTH_BYTES;
